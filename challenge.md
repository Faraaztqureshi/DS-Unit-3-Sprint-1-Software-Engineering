...
**I really pay attention to the comments and docstrings.  Usually they give me insight if variables/attributes are not clear and give me guidance about what the function/method is supposed to be doing.  I think I learned in this sprint that while it takes a lot longer initially, adding these features makes code a lot more reproducible.  

- We have an awful lot of computers here, and it gets pretty confusing with
  slightly different things running on all of them. How could containers help us
  improve this situation?
**A container is useful because you can send your package to users across all kinds of different operating systems since it has its own operating kernal and it is useful because using a container wont create confilcts with other libraries or dependencies a user already has on thier machine
